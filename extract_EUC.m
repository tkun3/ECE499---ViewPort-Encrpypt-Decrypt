...
for i = rowIncrements:(rowIncrements*2):rows
   ...
   for j = colIncrements:(colIncrements*2):columns
       ...
       while  lab1Distance > 25 %&& inputImage(i-dec,j,1) > R && inputImage(i-dec,j,3) > B
           dec = dec + 1;
           X1 = i - dec;
       ...
       while lab2Distance > 25 %&& inputImage(i+inc,j,1) > R && inputImage(i+inc,j,3) > B
           inc = inc + 1;
           X2 = i + inc;
       ...
       while lab3Distance > 25 %&& inputImage(i,j-dec,1) > R && inputImage(i,j-dec,3) > B
           dec = dec + 1;
           Y1 = j - dec;
       ...
       while lab4Distance > 25 %&& inputImage(i,j+inc,1) > R && inputImage(i,j+inc,3) > B
           inc = inc + 1;
           Y2 = j + inc;
